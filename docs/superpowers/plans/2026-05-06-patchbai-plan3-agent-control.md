# Patchbai Plan 3 — Full Agent Control Loop
...
- [ ] **Step 1: Open `patchbai/orchestrator/tools.py` and replace its contents with**
...
**Files:**
- Create: `patchbai/agents/request_inbox.py`
...
- [ ] **Step 3: Implement `patchbai/agents/request_inbox.py`**
...
- [ ] **Step 3: Modify `patchbai/agents/session.py`**
...
```bash
git add patchbai/agents/session.py tests/test_agent_session_send_lock.py
...
In `patchbai/orchestrator/session.py`, replace `wait_idle` with:
...
```bash
git add patchbai/orchestrator/session.py tests/test_orchestrator_session_serializes.py
...
- [ ] **Step 3: Modify `patchbai/agents/manager.py`**
...
**Files:**
- Create: `patchbai/agents/child_tools.py`
...
- [ ] **Step 3: Implement `patchbai/agents/child_tools.py`**
...
```bash
git add patchbai/agents/child_tools.py tests/test_child_tools.py
...
```bash
git add patchbai/agents/manager.py
...
- [ ] **Step 3: Add four new tool builders to `patchbai/orchestrator/tools.py`**
...
```bash
git add patchbai/orchestrator/tools.py tests/test_orchestrator_tools_send_interrupt_kill.py tests/test_orchestrator_tools_respond.py
...
- [ ] **Step 1: Modify `patchbai/orchestrator/session.py`**
...
- [ ] **Step 3: Modify `patchbai/widgets/agent_transcript.py`**
...
```bash
git add patchbai/widgets/agent_transcript.py tests/test_agent_transcript_input.py
...
```bash
git add patchbai/agents/manager.py tests/test_direct_message_to_agent.py
...
```bash
cd /Users/jimmy.mills/Developer/patchbai && .venv/bin/pytest tests/test_real_sdk_smoke.py -v
```
