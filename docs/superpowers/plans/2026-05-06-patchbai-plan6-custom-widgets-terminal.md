# Patchbai Plan 6 — Mode-C Custom Widgets + Terminal
...
from patchbai.layout.registry import UnknownWidgetError, WidgetRegistry
...
- [ ] **Step 3: Add `unregister` to `patchbai/layout/registry.py`**
...
```bash
git add patchbai/layout/registry.py tests/test_layout_registry_unregister.py
...
**Files:**
- Create: `patchbai/layout/custom_widgets.py`
...
- [ ] **Step 3: Implement `patchbai/layout/custom_widgets.py`**
...
```bash
git add patchbai/orchestrator/tools.py tests/test_orchestrator_tools_custom_widgets.py
...
In `patchbai/app.py`, add the import at the top:
...
**Files:**
- Modify: `patchbai/widgets/log_tail.py`
...
- [ ] **Step 3: Modify `patchbai/widgets/log_tail.py`**
...
```bash
git add patchbai/widgets/log_tail.py tests/test_widget_log_tail_rotation.py
...
**Files:**
- Modify: `patchbai/widgets/file_viewer.py`
...
In `patchbai/widgets/file_viewer.py`, replace the class docstring:
...
```bash
git add patchbai/widgets/file_viewer.py
...
```bash
cd /Users/jimmy.mills/Developer/patchbai && .venv/bin/python -c "
from patchbai.app import PatchbaiApp, build_default_registry
from patchbai.layout.custom_widgets import register_custom_widget, CustomWidgetError
from patchbai.widgets.terminal import Terminal
